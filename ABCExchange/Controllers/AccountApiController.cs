...
namespace ABCExchange.Controllers
{
    ...
    public class AccountApiController : BaseApiController
    {
        ...
        public AccountApiController(TokenService tokenService,UserManager<AppUser> userManager,SignInManager<AppUser> signInManager,RoleManager<AppRole> roleManager)
        {
